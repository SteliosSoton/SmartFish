...
volatile uint16_t ADCResults[SENSOR_COUNT+1]; //array for holding adc conversion outputs. First bit used as a counter so interrupt knows which bit to place result in
