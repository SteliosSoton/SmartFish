...
public:
   ...
   // void readDataBase();//this is redundant, it's not a good place for it
    void addPoint(QDateTime dataNumber, int dataValue);//int dataNumber
    void setGraphType(QString desiredType);
    void setIdeal(float ideal);
public slots:
    void rangeSignal(int desiredstart);
